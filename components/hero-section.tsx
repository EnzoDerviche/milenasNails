  ...
  return (
    <section id="inicio" className="py-16 px-4">
      <div className="container mx-auto max-w-4xl text-center">
        <div className="mb-8">
          <Sparkles className="w-12 h-12 text-[#b88f6a] mx-auto mb-4" />
          <h1 className="text-4xl md:text-6xl font-bold text-[#5f4632] mb-6">
            Bienvenida a{" "}
            <span className="bg-gradient-to-r from-[#c9a27e] to-[#b88f6a] bg-clip-text text-transparent">
              Milenas Nails
            </span>
          </h1>
          <p className="text-xl text-[#7a634f] leading-relaxed max-w-3xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-12">
          <Card className="bg-white/80 backdrop-blur-sm border-[#e6d8c8] hover:shadow-lg transition-all duration-300">
            <CardContent className="p-6 text-center">
              <Star className="w-8 h-8 text-[#b88f6a] mx-auto mb-3" />
              <h3 className="font-semibold text-[#5f4632] mb-2">
                Atención Personalizada
              </h3>
              <p className="text-[#7a634f] text-sm">
          ...
          <Card className="bg-white/80 backdrop-blur-sm border-[#e6d8c8] hover:shadow-lg transition-all duration-300">
            <CardContent className="p-6 text-center">
              <Sparkles className="w-8 h-8 text-[#b88f6a] mx-auto mb-3" />
              <h3 className="font-semibold text-[#5f4632] mb-2">
                Diseños Únicos
              </h3>
              <p className="text-[#7a634f] text-sm">
        ...
        <Button
          className="bg-gradient-to-r mt-5 from-[#c9a27e] to-[#b88f6a] hover:from-[#b88f6a] hover:to-[#a97d57] text-white px-8 py-3 rounded-full text-lg font-semibold shadow-lg hover:shadow-xl transition-all duration-300"
        >
          <a
